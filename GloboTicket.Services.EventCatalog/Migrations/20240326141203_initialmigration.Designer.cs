...
namespace GloboTicket.Services.EventCatalog.Migrations
{
    ...
    [Migration("20240326141203_initialmigration")]
            ...
            modelBuilder.Entity("GloboTicket.Services.EventCatalog.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Artist = "John Egbert",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2024, 9, 26, 14, 12, 3, 570, DateTimeKind.Local).AddTicks(8206),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2024, 12, 26, 14, 12, 3, 573, DateTimeKind.Local).AddTicks(281),
                        ...
                        new
                        {
                            ...
                            Artist = "DJ 'The Mike'",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2024, 7, 26, 14, 12, 3, 573, DateTimeKind.Local).AddTicks(394),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2024, 7, 26, 14, 12, 3, 573, DateTimeKind.Local).AddTicks(424),
                        ...
                        new
                        {
                            ...
                            Artist = "Many",
                            CategoryId = new Guid("fe98f549-e790-4e9f-aa16-18c2292a2ee9"),
                            Date = new DateTime(2025, 1, 26, 14, 12, 3, 573, DateTimeKind.Local).AddTicks(447),
                        ...
                        new
                        {
                            ...
                            Artist = "Nick Sailor",
                            CategoryId = new Guid("6313179f-7837-473a-a4d5-a5571b43e6a6"),
                            Date = new DateTime(2024, 11, 26, 14, 12, 3, 573, DateTimeKind.Local).AddTicks(519),
